...
public class Data extends  Config {
    ...
    public void auth(){
        ...
        public void insertNewMassage (String name , String massage){
            try {
                PreparedStatement insert =  connection.prepareStatement("INSERT INTO messages(username,message) "+
                        "VALUES(?,?)");
               insert.setString(1,name);
                insert.setString(2,massage);
